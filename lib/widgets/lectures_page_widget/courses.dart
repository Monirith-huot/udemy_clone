                    ...
                    title: Container(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 5),
                          Text(
                            lecturerCourse[index].instructorName,
                            style: _textStyle(
                              Colors.white,
                              8,
                              FontWeight.normal,
                          ...
                          Row(
                            children: [
                              Text(
                                lecturerCourse[index].rating.toString(),
                                style: _textStyle(
                              ...
                              Text(
                                "(" +
                                    lecturerCourse[index].students.toString() +
                                    ")",
                                style: _textStyle(
                                  Colors.grey,
                                  8,
